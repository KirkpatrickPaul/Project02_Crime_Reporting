...
$(document).ready(() => {
  ...
  function createCrimeRow (crimeData) {
    ...
    newTr.append(
      "<td><a href='/blog?crime_id=" + crimeData.id + "'>Go to Crimes</a></td>"
    );
    newTr.append(
      "<td><a href='/cms?crime_id=" + crimeData.id + "'>Create a Crime</a></td>"
    );
    newTr.append(
      "<td><a style='cursor:pointer;color:red' class='delete-crime'>Delete Crime</a></td>"
    );
    return newTr;
  }
